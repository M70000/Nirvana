...
ImGuiStyle::ImGuiStyle()
{
    ...
    ChildRounding = 4.0f;             // Radius of child window corners rounding. Set to 0.0f to have rectangular child windows
    ChildBorderSize = 1.0f;             // Thickness of border around child windows. Generally set to 0.0f or 1.0f. Other values not well tested.
    PopupRounding = 4.0f;             // Radius of popup window corners rounding. Set to 0.0f to have rectangular child windows
    ...
    GrabRounding = 4.0f;             // Radius of grabs corners rounding. Set to 0.0f to have rectangular slider grabs.
