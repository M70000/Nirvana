#include "grenade_circle.h"
#include "../valve_sdk/csgostructs.hpp"
#include "../options.hpp"

void GrenadeDetonateEvent::FireGameEvent(IGameEvent* event)
{
...
int GrenadeDetonateEvent::GetEventDebugID(void)
{
	return EVENT_DEBUG_ID_INIT;
}

void GrenadeDetonateEvent::RegisterSelf()
{
...
void GrenadeDetonateEvent::UnregisterSelf()
{
	g_GameEvents->RemoveListener(this);
}

void GrenadeDetonateEvent::Paint(void)
{
	if (!g_Options.misc_grenade_circle)
		return;
	...
	auto get_grenade_color = [=](int type) -> Color
	{
		switch (type % 3)
		{
		case 0: return Color(g_Options.color_beam_smoke);
		case 1: return Color(g_Options.color_beam_molotov);
		case 2: return Color(g_Options.color_beam_decoy);
		}
		return {};
	};
