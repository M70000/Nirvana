...
bool C_BaseEntity::IsWeapon( ) {
	...
	return CallVFunction<bool( __thiscall* )( C_BaseEntity* )>( this, 166 /*165*/ )( this );
}
...
{
	static auto fnGetWpnData = reinterpret_cast<CCSWeaponInfo*(__thiscall*)(void*)>(Utils::PatternScan(GetModuleHandleW(L"client.dll"), "55 8B EC 81 EC ? ? ? ? 53 8B D9 56 57 8D 8B"));
...
float C_BaseCombatWeapon::GetInaccuracy( ) {
	return CallVFunction<float( __thiscall* )( void* )>( this, /*482*/483 )( this );
}

float C_BaseCombatWeapon::GetSpread( ) {
	return CallVFunction<float( __thiscall* )( void* )>( this, /*452*/453 )( this );
}

void C_BaseCombatWeapon::UpdateAccuracyPenalty( ) {
	CallVFunction<void( __thiscall* )( void* )>( this, /*483*/484 )( this );
}
...
AnimationLayer *C_BasePlayer::GetAnimOverlays( ) {
	return *( AnimationLayer** )( ( DWORD )this + /*0x2980*/0x2990 );
}

float C_BasePlayer::GetDesyncDelta() {
	if (auto anim_state = g_LocalPlayer->GetPlayerAnimState()) {
		float yaw_modifier = (anim_state->m_flStopToFullRunningFraction * -0.3f - 0.2f) * std::clamp(anim_state->m_flFeetSpeedForwardsOrSideWays, 0.0f, 1.0f) + 1.0f;

		if (anim_state->m_fDuckAmount > 0.0f)
			yaw_modifier += (anim_state->m_fDuckAmount * std::clamp(anim_state->m_flFeetSpeedUnknownForwardOrSideways, 0.0f, 1.0f) * (0.5f - yaw_modifier));
...
CCSGOPlayerAnimState *C_BasePlayer::GetPlayerAnimState( ) {
	...
	return *( CCSGOPlayerAnimState** )( ( DWORD )this + /*0x3900*/0x9960 );
}
...
void C_BasePlayer::UpdateClientSideAnimation( ) {
	return CallVFunction< void( __thiscall* )( void* ) >( this, 224/*224*/ )( this );
}
