...
public:
    ...
    void Clamp(void) {
        ...
        yaw = std::clamp(std::remainder(yaw, 360.0f), -180.0f, 180.0f);
    ...
    static auto fromAngle(const QAngle& angle) noexcept
    {
        ...
        return QAngle{ std::cos(degreesToRadians(angle.pitch)) * std::cos(degreesToRadians(angle.yaw)),
                       std::cos(degreesToRadians(angle.pitch)) * std::sin(degreesToRadians(angle.yaw)),
                      -std::sin(degreesToRadians(angle.pitch)) };
    }
