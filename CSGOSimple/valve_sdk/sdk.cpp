...
static T* FindHudElement(const char* name)
{
    ...
    static auto find_hud_element = reinterpret_cast<DWORD(__thiscall*)(void*, const char*)>(Utils::PatternScan(GetModuleHandleW(L"client.dll"), "55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 39"));
...
IEffects*        g_LocalEffects = nullptr;
INetChannel*          g_NetChannel     = nullptr;
NetworkStringTableContainer* networkStringTableContainer = nullptr;
...
C_BaseHudChat* g_ChatElement = nullptr;
...
namespace Interfaces
{
    ...
    void Initialize()
    {
        ...
        networkStringTableContainer        = get_interface<NetworkStringTableContainer>      (engineFactory   , "VEngineClientStringTable001");
        ...
        g_FileSystem          = get_interface<void>				   (fileSysFactory, "VFileSystem017" );
		g_Localize			  = get_interface<ILocalize>		   (localizeFactory	, "Localize_001");
		g_LocalEffects        = get_interface< IEffects >          ( clientFactory  , "IEffects001" );
    ...
    void Dump()
    {
        ...
        PRINT_INTERFACE(networkStringTableContainer);
