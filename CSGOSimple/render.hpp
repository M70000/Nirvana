...
extern ImFont* g_pVelocityFont;
extern ImFont* g_pAstriumFont;
extern ImFont* g_pSmallestPixelFont;
extern ImFont* g_pTahomaFont;
...
public:
	...
	void DrawBeamCircle(Color clr, int width, Vector pos);
